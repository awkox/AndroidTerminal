...
value class TextStyle(val value: Long) {
    ...
    val foreColor: Int
        get() = if ((value and CHARACTER_ATTRIBUTE_TRUECOLOR_FOREGROUND.toLong()) == 0L) {
            ...
            -0x1000000 or ((value ushr 40) and 0x00ffffffL).toInt()
        }
    ...
    companion object {
        ...
        fun encodeExtendedEffect(underlineStyle: Int, underlineColor: Int): Long {
            ...
            if ((underlineColor and -0x1000000) == -0x1000000) {
                result = result or EXT_TRUECOLOR_UNDERLINE or ((underlineColor.toLong() and 0x00ffffffL) shl EXT_UNDERLINE_COLOR_SHIFT)
            } else {
